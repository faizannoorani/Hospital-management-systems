...
MIDDLEWARE = [
    ...
    'myapp.middleware.apointment_middleware',
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Hospital_managment',                    # Database ka naam
...
SIMPLE_JWT = {
    ...
    "ROTATE_REFRESH_TOKENS": False,                  # Refresh token rotate hoga ya nahi
    "BLACKLIST_AFTER_ROTATION": True,                # Purana refresh token blacklist hoga ya nahi
}
